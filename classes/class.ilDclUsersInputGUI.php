...
/**
 * Class ilDclUsersInputGUI
 * extended to support form confirmation
 *
 * @ilCtrl_IsCalledBy ilDclUsersInputGUI: ilUIPluginRouterGUI
 * @ilCtrl_Calls ilDclUsersInputGUI: ilRepositorySearchGUI
 *
 */
class ilDclUsersInputGUI extends ilDclTextInputGUI
{
    /**
     * ilDclUsersInputGUI constructor.
    ...
    public function __construct($a_title = "", $a_postvar = "")
    {
        ...
        $ajax_url =$this->ctrl->getLinkTargetByClass(
            ['iluipluginroutergui', 'ildclusersinputgui','ilrepositorysearchgui'],
            'doUserAutoComplete',
            '',
            true,
            false
